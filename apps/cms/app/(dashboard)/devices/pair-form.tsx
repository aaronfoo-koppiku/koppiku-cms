      ...
      <form action={action} className="flex flex-wrap gap-3 items-end">
        <div className="space-y-1.5">
          ...
          <input name="pairing_code" placeholder="123456" maxLength={6} required
            className="w-32 border border-gray-200 rounded-lg px-3 py-2 text-sm font-mono tracking-widest text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-amber-400 transition-colors" />
        </div>
        {outlets.length > 0 && (
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-gray-600">Outlet</label>
            <select name="outlet_id"
              className="border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-amber-400 transition-colors">
